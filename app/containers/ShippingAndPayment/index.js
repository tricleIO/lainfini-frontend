...
class ShippingAndPaymentForm extends React.Component {
  ...
  render() {
    ...
    const { billingAddress, countries } = this.props;
              ...
              <div className="row">
                ...
                <div className="col-12 col-md-6">
                  <div className="form-group">
                    ...
                    <Field component={Select} defaultValue={billingAddress.country} className="form-control" id="countrySelectBox" name="country" aria-describedby="emailHelp">
                      {
                ...
                <div className="col-12 mb-4 payment--method">
                  <label className="custom-control custom-radio mb-4 mb-sm-0">
                ...
                <div className="col-12 col-md-6 col-lg-3 mt-5 mb-5 text-center">
                  <button className="btn text-uppercase ">proceed</button>
                </div>
              </div>
            </div>
          </div>
